...
-- ============================================
INSERT INTO `service_request` (`request_id`, `cliente_id`, `service_type`, `location`, `deadline`, `budget`) VALUES
...
-- INSERIR PROPOSTAS
-- ============================================
INSERT INTO `proposal` (`proposal_id`, `request_id`, `service_provider_id`, `amount`, `estimate`, `message`) VALUES
...
-- INSERIR CONTRATOS
-- ============================================
INSERT INTO `contract` (`contract_id`, `request_id`, `service_provider_id`, `cliente_id`, `contract_terms`, `status`) VALUES
(1, 1, 1, 1, 'Serviço de encanamento com garantia de 3 meses. Materiais inclusos.', 'completed'),
(2, 2, 2, 2, 'Instalação elétrica completa com certificado de segurança.', 'completed'),
(3, 3, 3, 1, 'Pintura completa de apartamento de 2 quartos com tinta Suvinil.', 'active'),
(4, 4, 3, 3, 'Limpeza geral pós-obra com produtos profissionais.', 'completed');
...
-- INSERIR AVALIAÇÕES
-- ============================================
INSERT INTO `review` (`review_id`, `contract_id`, `cliente_id`, `rating`, `comment`) VALUES
...
-- ============================================
INSERT INTO `chat` (`chat_id`, `cliente_id`, `service_provider_id`, `message`) VALUES
(1, 1, 1, 'Olá, gostaria de saber mais detalhes sobre o serviço de encanamento.'),
(2, 1, 1, 'Claro! Posso fazer uma visita técnica amanhã para avaliar o problema.'),
(3, 2, 2, 'Preciso de uma instalação elétrica urgente. Está disponível?'),
(4, 2, 2, 'Sim, posso atender ainda esta semana. Qual o melhor horário para você?');