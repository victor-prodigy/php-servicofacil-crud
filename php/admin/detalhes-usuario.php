...
try {
    ...
    if ($usuario['tipo_usuario'] === 'cliente') {
        ...
        $stats_sql = "SELECT 
                        ...
                        COUNT(CASE WHEN sr.status = 'concluido' THEN 1 END) as solicitacoes_concluidas,
        ...
        $stats_sql = "SELECT 
                        ...
                        COUNT(CASE WHEN sr.status = 'concluido' THEN 1 END) as propostas_aceitas,
    ...
    $resposta = [
        ...
        'usuario' => [
            ...
            'status' => $usuario['identity_verified'] ? 'ativo' : 'inativo',
